...
export default function PrivacyPolicy() {
  return (
    <div style={{ maxWidth: 800, textAlign: "left", paddingBottom: "60px", marginTop: "40px", lineHeight: "1.7" }}>
      ...
      <section style={sectionStyle}><h3 style={headingStyle}>1. Postanowienia ogólne</h3><p style={textStyle}>Chati pozwala korzystać z losowego czatu i części pokojów bez zakładania konta. Konto jest opcjonalne i służy do zachowania nazwy użytkownika, ulubionych pokojów, znajomych oraz prywatnych wiadomości. Niniejsza polityka opisuje dane przetwarzane zarówno dla gości, jak i zalogowanych użytkowników.</p></section>
      ...
      <section style={sectionStyle}>
        <h3 style={headingStyle}>6. Zgłoszenia i moderacja</h3>
      ...
      <section style={sectionStyle}><h3 style={headingStyle}>7. Formularz kontaktowy</h3><p style={textStyle}>Dane podane w formularzu kontaktowym, takie jak opcjonalny adres e-mail i treść zgłoszenia, są przetwarzane w celu obsługi wiadomości, błędu lub zgłoszenia dotyczącego Serwisu.</p></section>

      <section style={sectionStyle}><h3 style={headingStyle}>8. Cookies i pamięć lokalna</h3><p style={textStyle}>Używamy bezpiecznych plików cookies do utrzymania sesji konta i panelu administracyjnego. Pamięć lokalna przeglądarki służy między innymi do zapamiętania akceptacji regulaminu, tymczasowego pseudonimu gościa oraz stabilnego identyfikatora klienta czatu.</p></section>

      <section style={sectionStyle}><h3 style={headingStyle}>9. Analityka</h3><p style={textStyle}>Możemy korzystać z narzędzi analitycznych do mierzenia odwiedzin i poprawy działania Serwisu. Funkcje analityczne podlegają ustawieniom zgody użytkownika i nie są wykorzystywane do odczytywania treści prywatnych rozmów.</p></section>

      <section style={sectionStyle}><h3 style={headingStyle}>10. Okres przechowywania i Twoje prawa</h3><p style={textStyle}>Dane przechowujemy przez okres potrzebny do świadczenia funkcji konta, bezpieczeństwa i realizacji obowiązków prawnych. Zgłoszenia i historia moderacji mogą być przechowywane dłużej, gdy jest to potrzebne do ochrony użytkowników, zapobiegania nadużyciom lub obsługi roszczeń. Zgodnie z RODO możesz poprosić o dostęp do swoich danych, ich poprawienie, ograniczenie przetwarzania lub usunięcie.</p></section>

      <section><h3 style={headingStyle}>11. Kontakt</h3><p style={textStyle}>Pytania dotyczące danych osobowych, usunięcia konta lub działania Serwisu możesz przesłać przez zakładkę <strong>Kontakt / Zgłoszenia</strong>.</p></section>
    </div>
  );
}
